...
void TestTree(const string &dbx_filename, const string &seq_filename, TreeType &a_tree) {
  ...
  //opening sequence file for 4a, 4b, 5a, 5b, 6a, 6b, and 6c
  ifstream twofile;
  ...
  // Read sequences.txt to count how many query were found
  ...
  //Read sequences.txt to remove every other sequence
